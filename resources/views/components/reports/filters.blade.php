@props([
    ...
    'canExport' => false,
    'report' => null,   // report key — enables the export menu (sales|inventory|mis)
...
@php
    ...
    $default = ['period', 'project_id', 'block_id', 'salesperson_id', 'booking_status', 'payment_status', 'plot_status'];
