...
it('creates all 17 master tables with the standard columns', function () {
    $tables = [
...
it('registers exactly 17 master resources, each mapping to a real model', function () {
    $resources = MasterRegistry::all();

    expect($resources)->toHaveCount(17);
